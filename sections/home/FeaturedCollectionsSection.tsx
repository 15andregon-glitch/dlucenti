    ...
    >
      <PageContainer className="collections-featured-container">
        <div className="collections-featured-inner">
          <h2 className="collections-editorial-intro__title">
            {t("collections.title")}
          </h2>

          <div className="collections-editorial-grid grid w-full gap-px bg-[var(--maison-hairline)] md:grid-cols-3">
                ...
                <Reveal key={collection.id}>
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      <h3 className="mt-2 font-editorial text-maison-title text-2xl transition-colors duration-300 group-hover:text-[var(--maison-gold)] md:text-[1.75rem]">
                        {collection.name}
                      </h3>
